...
export interface _SERVICE {
  'allClptBalances' : ActorMethod<
    [],
    Array<[UserPeriodIdentify, DepositeInfo]>
  >,
  ...
  'autoIntevetment' : ActorMethod<[bigint, boolean], Result>,
  'balance' : ActorMethod<[Principal], bigint>,
  'balances' : ActorMethod<[UserAssetIdentify], AssetInfo>,
  'clptBalances' : ActorMethod<[Principal], Array<[bigint, DepositeInfo]>>,
  'collateralInspection' : ActorMethod<[], undefined>,
  'depositeInfo' : ActorMethod<[UserPeriodIdentify], DepositeInfo>,
